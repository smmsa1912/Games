        ...
        if s_player == 5:
            ...
            if Again == 'No':
                ...
                if s_com < s_player:
                    score = s_player - s_com
                    if score > 1:
                        print(' You Won This Match By:', score,'Points')
                    else:
                        print(' You Won This Match By:', score,'Point')
                elif s_com > s_player:
                    score = s_com - s_player
                    if score > 1:
                        print(' You Lose This Match By:', score,'Points')
                    else:
                        print(' You Lose This Match By:', score,'Point')
                elif s_com == s_player:
                    score = s_com or s_player
                    print(' This Match Draw A Your Score And Computer Score Is:', score)
                time.sleep(0.4)
                quit()
            elif Again == 'N':
                print(' :(')
